  ...
  return (
    ...
    <div className="faq flex flex-col justify-center items-center my-20">
      ...
      <div onClick={() => handleClick(1)} className="q1 bg-white shadow-xl  flex flex-col justify-between items-center cursor-pointer border-b-2">
        <div className={`flex justify-between items-center w-[40rem] sm:w-[50rem] md:w-[80rem] py-[8px] px-[20px] md:py-[18px] md:px-[45px] transition duration-300 ${activeText === 1 ? 'bg-main text-white' : ''}`}>
        ...
        <div className={`div ${activeText === 1 ? 'show' : 'div'}`}>
            <p className='text-[#706f7b] text-[16px] w-[40rem] sm:w-[50rem] md:w-[80rem] py-[2.8rem] px-[4.5rem]'>Comparing rental car deals is important as it helps find the
      ...
      <div onClick={() => handleClick(2)} className="q1 bg-white shadow-xl  flex flex-col justify-between items-center cursor-pointer border-b-2">
        <div className={`flex justify-between items-center w-[40rem] sm:w-[50rem] md:w-[80rem] py-[8px] px-[20px] md:py-[18px] md:px-[45px] transition duration-300 ${activeText === 2 ? 'bg-main text-white' : ''}`}>
          <h2 className='text-[15px] sm:text-[18px]'>2.How do I find the car rental deals? </h2>
          <span><BiChevronDown size={30}/></span>
        </div>
        <div className={`div ${activeText === 2 ? 'show' : 'div'}`}>
            <p className='text-[#706f7b] text-[16px] w-[40rem] sm:w-[50rem] md:w-[80rem] py-[2.8rem] px-[4.5rem]'>
      ...
      <div onClick={() => handleClick(3)} className="q1 bg-white shadow-xl  flex flex-col justify-between items-center cursor-pointer ">
        <div className={`flex justify-between items-center w-[40rem] sm:w-[50rem] md:w-[80rem] py-[8px] px-[22px] md:py-[18px] md:px-[45px] transition duration-300 ${activeText === 3 ? 'bg-main text-white' : ''}`}>
