...
const Downloadapp = () => {
    ...
    <div className='download-section w-full'>
        ...
        <div className="con max-w-[133rem] sm:px-[2.5rem] mx-auto">
            <div className="text flex flex-col gap-[2rem] max-w-[55rem] text-center md:text-left px-5">
                ...
                <div className="svgs flex flex-wrap items-center gap-10 justify-center md:justify-start sm:gap-14 mt-6">
