...
import CarAudi from "../../assets/audia1.jpg";
import CarGolf from "../../assets/golf6.jpg";
import CarToyota from "../../assets/toyotacamry.jpg";
          ...
          <div className="book-content">
            <div className="book-content__box">
              ...
              <p className="booking-done">
                ...
                <FaTimes width={20} height={20} onClick={hideMessage} />
              </p>

              <form className="box-form">
                <div className="box-form__car-type">
                  <label>
                    <AiFillCar className="input-icon" /> &nbsp; Select Your Car
                    Type <b>*</b>
                  </label>
