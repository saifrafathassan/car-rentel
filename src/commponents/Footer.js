...
const Footer = () => {
  return (
    <div className='bg-[#fff] w-full h-full flex flex-wrap justify-center gap-20 sm:gap-0 mx-auto pt-[100px] pb-[110px]'>
        ...
        <div className="col-1 w-[300px] px-5">
        ...
        <div className="col-2 w-[300px] px-5">
        ...
        <div className="col-3 w-[300px] px-5">
        ...
        <div className="col-4 w-[300px] px-5">
          ...
          <ul>
            <li className='text-[1.6rem] mb-4'><input className='bg-[#ececec] text-center border-transparent border-[1px] mt-1 outline-none py-[10px] w-full sm:px-[55px]' type="email" placeholder='Enter Email Address' /></li>
