      ...
      <div className='flex justify-center items-center h-full mx-auto lg:w-[1350px]'>
        <div className="lg:text-start w-[500px] text-center lg:w-[600px] md:ml-4">
            ...
            <div className="btn text-white lg:justify-start justify-center flex flex-wrap gap-7 py-5">
                ...
                <Link to="/about"><button className='py-[18px] text-[17px] px-[30px] bg-black rounded-md flex items-center gap-4 shadow-xl hover:bg-white hover:text-black transition-colors duration-300'>Learn More <BiChevronRight size={25}/></button></Link>
            </div>
        </div>
