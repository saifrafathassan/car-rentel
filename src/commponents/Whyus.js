    ...
    <div className='bg-[#fff] py-12 w-full h-full items-center flex flex-col justify-center bg-img'>
      ...
      <div className="main-content flex justify-center gap-[160px] flex-wrap w-full">
        ...
        <div className="frist-col text-black flex flex-col sm:text-start sm:items-start justify-center items-center text-center">
          ...
          <p className='text-[16px] px-1 text-[#706f7b] mt-10 sm:w-[500px]'>Discover the best deals you'll ever find with our unbeatable offers. We're dedicated to providing you with the best value for your money, so you can enjoy top-quality services and products without breaking the bank. Our deals are designed to give you the ultimate renting experience, so don't miss out on your chance to save big.</p>
          <div>
            <Link onClick={() => window.scrollTo(0,0)} to="/ourteam"><button className='mt-14 flex items-center font-bold text-white py-[15px] px-[25px] text-[16px] bg-main rounded shadow-xl hover:bg-red-600 transition-colors duration-300'>Find Details <BiChevronRight size={25}/></button></Link>
          </div>
        </div>
